            ...
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-slate-900/95 to-slate-800/95 backdrop-blur-2xl rounded-3xl border-2 border-slate-700/50 overflow-hidden shadow-2xl shadow-black/50">
                ...
                <div className="relative h-[600px] rounded-3xl overflow-hidden shadow-2xl shadow-black/70">
                  ...
                  {/* Controls */}
                  <div className="absolute top-20 left-6 right-6 z-30 flex justify-between items-center">
                    <div className="px-4 py-2 bg-black/70 backdrop-blur-md rounded-full border border-white/20">
                  ...
                  {/* Navigation */}
                    onClick={prevImage}
                    className="absolute left-6 top-1/2 -translate-y-1/2 w-12 h-12 bg-black/70 backdrop-blur-md rounded-full flex items-center justify-center text-white hover:bg-black/80 transition-all duration-300 hover:scale-110"
                  >
                    <ChevronLeft className="w-5 h-5" />
                    onClick={nextImage}
                    className="absolute right-6 top-1/2 -translate-y-1/2 w-12 h-12 bg-black/70 backdrop-blur-md rounded-full flex items-center justify-center text-white hover:bg-black/80 transition-all duration-300 hover:scale-110"
                  >
